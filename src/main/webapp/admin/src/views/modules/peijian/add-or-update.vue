<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配件分类" prop="peijianfenlei">
          <el-input v-model="ruleForm.peijianfenlei" 
              placeholder="配件分类" clearable  :readonly="ro.peijianfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配件分类" prop="peijianfenlei">
              <el-input v-model="ruleForm.peijianfenlei" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供销商名称" prop="gongxiaoshangmingcheng">
          <el-input v-model="ruleForm.gongxiaoshangmingcheng" 
              placeholder="供销商名称" clearable  :readonly="ro.gongxiaoshangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供销商名称" prop="gongxiaoshangmingcheng">
              <el-input v-model="ruleForm.gongxiaoshangmingcheng" 
                placeholder="供销商名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配件价格" prop="peijianjiage">
          <el-input v-model="ruleForm.peijianjiage" 
              placeholder="配件价格" clearable  :readonly="ro.peijianjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配件价格" prop="peijianjiage">
              <el-input v-model="ruleForm.peijianjiage" 
                placeholder="配件价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="配件介绍" prop="peijianjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.peijianjieshao" label="配件介绍" prop="peijianjieshao">
                    <span v-html="ruleForm.peijianjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	peijianjieshao : false,
      ...
      rules: {
          ...
          peijianjiage: [
                { required: true, message: '配件价格不能为空', trigger: 'blur' },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pailiang = true;
          ...
          if(o=='gongxiaoshangmingcheng'){
            this.ruleForm.gongxiaoshangmingcheng = obj[o];
	    this.ro.gongxiaoshangmingcheng = true;
            continue;
          }
          if(o=='dizhi'){
	...
	this.ruleForm.peijianjieshao = this.ruleForm.peijianjieshao.replace(reg,'../../../ssm0dq3x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
