<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约项目" prop="yuyuexiangmu">
          <el-input v-model="ruleForm.yuyuexiangmu" 
              placeholder="预约项目" clearable  :readonly="ro.yuyuexiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约项目" prop="yuyuexiangmu">
              <el-input v-model="ruleForm.yuyuexiangmu" 
                placeholder="预约项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuyuedanhao = true;
          ...
          if(o=='yuyuexiangmu'){
            this.ruleForm.yuyuexiangmu = obj[o];
	    this.ro.yuyuexiangmu = true;
            continue;
          }
          if(o=='yuyueriqi'){
