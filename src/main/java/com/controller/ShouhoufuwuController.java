...
public class ShouhoufuwuController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShouhoufuwuEntity shouhoufuwu, HttpServletRequest request){
    ...
    public R save(@RequestBody ShouhoufuwuEntity shouhoufuwu, HttpServletRequest request){
    	shouhoufuwu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R add(@RequestBody ShouhoufuwuEntity shouhoufuwu, HttpServletRequest request){
    	shouhoufuwu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(shouhoufuwu);
    	shouhoufuwu.setUserid((Long)request.getSession().getAttribute("userId"));
    ...
    public R update(@RequestBody ShouhoufuwuEntity shouhoufuwu, HttpServletRequest request){
        //ValidatorUtils.validateEntity(shouhoufuwu);
        shouhoufuwuService.updateById(shouhoufuwu);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShouhoufuwuEntity> wrapper = new EntityWrapper<ShouhoufuwuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shouhoufuwuService.selectCount(wrapper);
